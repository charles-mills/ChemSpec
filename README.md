...
- [Generalized chemistry rules](docs/generalized-chemistry-rules.md)
- [Trusted catalogue coverage](docs/catalogue-coverage.md)
...
[dynamic reaction rebuild](docs/plans/dynamic-reaction-rebuild-plan.md).
