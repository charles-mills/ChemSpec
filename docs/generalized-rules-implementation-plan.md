...
> [generalized chemistry design](generalized-chemistry-rules.md). G0 through G5
> are implemented and independently reviewed. G6 remains queued in the order
> below.
...
- Admit at most 64 parameters and reject Cartesian domains above 4,096 bindings
  before enumeration.
- Bound generalized coefficients at eight, total instances at 32, and raw
  match/certificate enumeration at 4,096 candidates.
